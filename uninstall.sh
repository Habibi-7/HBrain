...
Options:
  ...
  --copilot      Remove only GitHub Copilot instructions from the current directory
...
if [ "$REMOVE_COPILOT" -eq 1 ]; then
  remove_owned_file ".github/copilot-instructions.md" "Copilot instructions"
fi
