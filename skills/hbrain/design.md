...
The baked templates (`templates/timeline.html`, `tasks.html`) are built
...
> Render <X> as an HTML artifact following `design.md`. Use the tokens
> and components verbatim. Keep it single-file.

For charts:

> Render <X> as an inline-SVG <pattern> from `design.md` §6. Use
